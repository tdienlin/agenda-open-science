...
Data taken from Rains, S. A., Levine, T. R., & Weber, R. (2018). Sixty years of quantitative communication research summarized: Lessons from 149 meta-analyses. Annals of the International Communication Association, 42(2), 105–124. https://doi.org/10.1080/23808985.2018.1446350.
...
Here we estimate the statistical power for a bivariate correlational design for four different potential effect sizes.
...
Here, we estimate the statistical power for other typical designs for the actual effect size reported by Rains et al. (2018). 
